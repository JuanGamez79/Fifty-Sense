...
import { saveCategoryIcon, ICON_OPTIONS } from "./Utils";
        ...
        <div className="cat-create">
          ...
          <div className="cat-icon-picker">
            {ICON_OPTIONS.map(icon => (
              <button key={icon} className={newIcon === icon ? "active" : ""} onClick={() => setNewIcon(icon)} type="button">
                {icon}
              </button>
            ))}
          </div>
                  ...
                  {isEditing ? (
                    <>
                      <div className="cat-rename-group">
                        ...
                        <div className="cat-icon-picker">
                          {ICON_OPTIONS.map(icon => (
                            <button key={icon} className={renameIcon === icon ? "active" : ""} onClick={() => setRenameIcon(icon)} type="button">
                              {icon}
                            </button>
                          ))}
                        </div>
